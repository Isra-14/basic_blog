...
function pagina_actual(){
    return isset($_GET['p']) ? (int)$_GET['p'] : 1; // * Si existe la variable 'p' devuelve el valor de la variable, sino devuelve 1
}

function obtener_post($post_por_pagina, $conexion){
    $inicio = (pagina_actual() > 1) ? pagina_actual() * $post_por_pagina - $post_por_pagina : 0; // * Calcula el total de articulos a mostrar por pagina
